...
from train_lyric_patch_calibrator import (  # noqa: E402
    SAMPLES_PER_GROUP,
...
def test_lyric_patch_training_groups_are_related_and_split_without_leakage() -> None:
...
def test_lyric_patch_training_data_contains_positive_and_harmful_proposals() -> None:
    ...
    assert "strong-lyric-majority" in scenarios
    assert "common-mode-text-confusion" in scenarios
