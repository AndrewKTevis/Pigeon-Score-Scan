...
from train_tie_patch_calibrator import (  # noqa: E402
    SAMPLES_PER_GROUP,
    SCENARIO_WEIGHTS,
...
from scorescan.tie_consensus import FEATURE_NAMES  # noqa: E402


def test_tie_patch_training_data_is_deterministic_and_grouped() -> None:
...
def test_tie_patch_training_data_covers_adversarial_scenarios() -> None:
