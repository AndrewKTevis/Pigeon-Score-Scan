...
from train_rhythm_patch_calibrator import SCENARIO_WEIGHTS, _split, build_dataset  # noqa: E402
from scorescan.rhythm_consensus import FEATURE_NAMES  # noqa: E402


def test_rhythm_patch_training_data_is_deterministic_and_grouped() -> None:
...
def test_rhythm_patch_training_data_covers_positive_and_adversarial_scenarios() -> None:
    dataset = build_dataset(seed=20260719, groups=768)
