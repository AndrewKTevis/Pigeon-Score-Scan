...
from train_tuplet_patch_calibrator import (  # noqa: E402
    SAMPLES_PER_GROUP,
    SCENARIO_WEIGHTS,
...
from scorescan.tuplet_consensus import FEATURE_NAMES  # noqa: E402


def test_tuplet_patch_training_data_is_deterministic_and_grouped() -> None:
    left = build_dataset(seed=20260719, groups=180)
    right = build_dataset(seed=20260719, groups=180)
...
def test_tuplet_patch_training_data_covers_adversarial_scenarios() -> None:
    dataset = build_dataset(seed=20260719, groups=1600)
    ...
    confirmation = build_dataset(seed=20260721, groups=1600)
