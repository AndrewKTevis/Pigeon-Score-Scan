...
from train_ornament_patch_calibrator import (  # noqa: E402
    SAMPLES_PER_GROUP,
...
def test_ornament_patch_training_groups_are_related_and_split_without_leakage() -> None:
...
def test_ornament_patch_training_data_contains_positive_and_harmful_proposals() -> None:
    ...
    assert "strong-trill-majority" in scenarios
    assert "common-mode-ornament-confusion" in scenarios
